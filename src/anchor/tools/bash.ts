...
import { BASH_COMMAND_DESCRIPTION, DEFAULT_BASH_TIMEOUT_MS, DEFAULT_MAX_OUTPUT_CHARS, MINIMAL_BASH_DESCRIPTION } from "../dsh/official";
...
export function registerDshBashTool(pi: ExtensionAPI, state: AdapterState): void {
	pi.registerTool({
		name: "bash",
		label: "bash",
